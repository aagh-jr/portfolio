  ...
  <SectionWrap id="reflection">
    <Container>
      ...
      <div style={{ background: '#141414', borderRadius: 24, padding: '44px 52px' }}>
        <div style={{ fontSize: 11, fontWeight: 700, color: '#3DAA74', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: 20 }}>What This Project Taught Me</div>
        <p style={{ fontSize: 24, lineHeight: 1.6, fontWeight: 300, color: 'white', maxWidth: 740, margin: '0 0 20px', letterSpacing: '-0.01em' }}>
          Usability isn't just about whether users <em>can</em> complete tasks — it's about whether they <em>want to</em>.
        </p>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.55)', maxWidth: 680, margin: 0 }}>
          Energy Ave's Round 2 data showed high task completion but inconsistent motivation — and that discrepancy became the most generative finding of the entire study. Learning to read that kind of tension in data, and translate it into design direction, is the core skill I developed here.
        </p>
      </div>
    </Container>
  </SectionWrap>
